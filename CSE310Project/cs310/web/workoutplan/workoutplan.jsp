            ...
            <div class="menu">
                ...
                <div class="rightmenu">
                    ...
                    <%
                        ...
                        List<Beginner> list = addBeginner.fetchBeginner();
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <table class="table table-striped table-dark">
                                <Caption class="caption text-center"><h4>Beginner Level Workout Plan</h4></Caption>
                                <thead>
                                    <tr>
                                        <th scope="col">#</th>
                                ...
                                <tbody>
                                    <%  int i=1;
                                        for (Beginner beginner : list) {
                                    %>
                                    <tr>   
                                        <th scope="row"><%=i%></th>
                                        <td><%=beginner.getReps()%></td>
                                        <td><%=beginner.getSets()%></td>
                                        <td><%=beginner.getType()%></td>
                                    </tr>
                                    <%i++;}
                                    %>
                                </tbody>
